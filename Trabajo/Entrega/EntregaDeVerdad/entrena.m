...
function Num = clasificaCaracter( C )
    ...
    Num=compara(Cod,P3,C(19,:)); %Encuentra a qué caracter corresponde la codificación
end
...
%
function letra = compara (N,P,F)
if N==2272702 && F(1)+F(2)<2
    letra=32; %0
...
elseif N==2231102 || N== 2270702 || N== 14271102
    letra=3;
elseif N==2021107 || N== 2275807 || N== 2271107 || N==2023127 || N==2279007
    letra =4;
elseif ((P(1)+P(2) <= 4) && N== 2270202) || N== 14270202 || N== 14551402 
    letra = 5;
elseif N== 2271402 || N== 2331402 
    letra = 6;
elseif N== 12272702 || N== 12212702 || N==27313302 || N== 12273302
    letra = 7;
elseif ((P(1)+P(2) > 4) && N== 2020202) || N== 2290202 || N== 2330202
    letra = 8;
elseif ((P(1)+P(2) <=4) && N== 2020202) || N== 2110202 
    letra = 9;
elseif N== 2333131 || N== 2613127
    letra = 10;% 'A'
elseif N== 2270202 && (P(1)+P(2) > 4)
    letra = 11;% 'B'
elseif N== 2121202 
    letra = 12;% 'C'
elseif N== 2272702 && F(1)+F(2)>=2
    letra = 13;% 'D'
elseif N== 2141402
    letra = 14;% 'E'
elseif N== 12141402
...
elseif  N== 14553313
    letra = 19;%'J'
elseif N==23140823|| N==23080802
	letra = 20;% 'K'
elseif N== 2121212 
    letra = 21;%'L'
elseif N==27900219 || N==27940219 || N==94022927 || N==27900229 || N==27270229
	letra = 22;%'M'
elseif N==27232927
    letra = 23;%'N'
elseif N==12120202
...
elseif N== 33333302 || N== 23232302
    letra = 27;%'T'
elseif N== 14272727 || N== 2272727 || N== 2279427
    letra = 28;%'U'
elseif N== 31313327 
    letra = 29;%'V'
elseif N== 58020261 || N==90020290
    letra = 30;%'W'
    %#################################### X
    %#################################### Y
